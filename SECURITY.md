...
- **Instanz-Lebenszyklus:** `yard-instance-manager` verändert ausschließlich
  ...
  erneut gebunden; Aktualisierungen erhalten hostlokale Backups und ein
  fortsetzbares Write-ahead-Journal. Symlinks, Junctions und Reparse-Pfade
  blockieren. Hostslots,
...
- **Instance lifecycle:** `yard-instance-manager` mutates only paths declared
  ...
  updates receive host-local backups and a resumable write-ahead journal, and
  symlink, junction and reparse boundaries block. Host slots, messages, archives,
